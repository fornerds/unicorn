...
public class AdminProductController {
    ...
    @GetMapping("/{id}")
    public ApiResponse<AdminProductResponse> getProduct(@PathVariable UUID id) {
    ...
    @PatchMapping("/{id}")
    public ApiResponse<AdminProductResponse> update(@PathVariable UUID id, @Valid @RequestBody AdminProductPatchRequest request) {
